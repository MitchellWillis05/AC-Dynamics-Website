document.addEventListener("DOMContentLoaded", function() {
    const servicesLink = document.getElementById("blog");
...
document.getElementById('single-room').addEventListener('click', function () {
    ...
    const single_icon = document.getElementById("single-icon")
    const house_icon = document.getElementById("house-icon")
    ...
    single_icon.style.display = "none";
